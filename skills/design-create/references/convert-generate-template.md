...
- If `$MOTION_INTENT` describes animations but `$MOTION_PACK` is empty: note in Generation Summary "Motion intent detected — run /design-tokens → Motion Pack to set a pack."
