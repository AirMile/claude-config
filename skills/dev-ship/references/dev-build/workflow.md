...
1. Load technique:
   - **TDD** → `Read(".claude/skills/dev-ship/references/dev-build/techniques/tdd.md")`
...
Follow [Discovery — Reuse-Discovery](.claude/skills/shared/SKILL-PATTERNS.md#reuse-discovery) for the canonical protocol.
