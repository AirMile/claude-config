...
- **Command session**: If currently in a command workflow (/dev-legacy-1-plan, /dev-legacy-debug, etc.)
...
|---------|---------------------|--------|--------|
| /dev-legacy-1-plan | Decisions | Action Items | Context Dump |
| /dev-legacy-2-code | Technical Log | Action Items | Summary |
| /dev-legacy-3-verify | Technical Log | Action Items | Lessons Learned |
| /dev-legacy-4-refine | Technical Log | Decisions | Summary |
| /dev-legacy-5-refactor | Technical Log | Decisions | Lessons Learned |
| /dev-legacy-debug | Technical Log | Decisions | Lessons Learned |
| /thinking-brainstorm | Summary | Decisions | Lessons Learned |
| /thinking-analyze | Decisions | Summary | Lessons Learned |
...
**Examples:**
- `.workspace/sessions/commands/dev-legacy-1-plan/2025-12-31-portfolio-layout.md`
- `.workspace/sessions/commands/dev-legacy-debug/2025-12-31-jwt-expiry.md`
...
**Context**: User is in /dev-legacy-1-plan workflow, FASE 2
...
Location: .workspace/sessions/commands/dev-legacy-1-plan/2025-12-31-portfolio-grid-design.md
```
...
**User**: `/core-save my-tailwind-notes`
