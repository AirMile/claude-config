...
| `pageHint`                  | frontend projects only — array of PAGE names this feature surfaces on. Written from PHASE 1 page-placement sparring. Omit if empty or "Not on a page" was selected. Read by `/design-create` Build to pre-populate the page-composition selection menu.                                                                                                                              |
