...
`/core-config-revert` of `/core-config-revert [file]`
...
Modified:
  - skills/core/commit/SKILL.md
  - agents/plan-synthesizer.md

Added (untracked):
  - skills/dev/new-skill/SKILL.md
...
options:
  ...
  - label: "skills/core/commit/SKILL.md"
    description: "Modified"
  - label: "agents/plan-synthesizer.md"
    description: "Modified"
  - label: "skills/dev/new-skill/SKILL.md"
...
```
school-website> code .claude/skills/core-commit/SKILL.md
# ... maakte per ongeluk iets kapot ...

school-website> /core-config-revert
# Toont wijzigingen
# Vraagt bevestiging
...
**Specifiek bestand:**
```
school-website> /core-config-revert skills/core/commit/SKILL.md
...
- `/core-config-sync` - Commit en push wijzigingen
- `/core-commit` - Commit in huidige project
