...
| ------------- | ----------------------------------------- | ------------------------------------------------ |
| No theme      | Skills use Tailwind defaults              | Suggest `/design-tokens` in next steps         |
| No design     | Skills ask user for page/flow info inline | Suggest `/design-create` in next steps         |
| No code       | Build/iterate skills cannot run           | Suggest `/design-create`                       |
...
Run Project State Detection (see `design-tokens/references/validation.md`).
