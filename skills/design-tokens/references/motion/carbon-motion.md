...
Carbon motion is injected through `/design-tokens → Motion Pack → Customize → Add easings from other systems`. It does not change the active pack. Typical use cases:
