export const meta = {
  name: "token-research",
  description:
    "Research the brand/colour landscape for design-tokens: competitor colours, free hue lanes, accessibility caveats",
  phases: [
    {
      title: "Research",
      detail: "fan out competitor / hue-occupancy / accessibility research",
    },
    {
      title: "Synthesize",
      detail: "merge into one landscape object with candidate accents",
    },
  ],
};
...
const compLine = competitors.length
  ? `Prioritise these competitors/peers: ${competitors.join(", ")}.`
  : "Pick the most relevant well-known products in this space.";
