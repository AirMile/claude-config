...
Pass `accumulatedDrift[]` into the chosen technique's prompt context so the critique takes into account what prior skills already identified.
...
**Step 1b: Manual input fallback (if no concept in .project/project.json found)**
