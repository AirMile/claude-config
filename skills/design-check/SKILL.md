---
name: design-check
description: Use when built UI features (web or game) need an audit before shipping. Web = Playwright runtime; game = static Theme-consistency check + /game-verify. Use with /design-check.
