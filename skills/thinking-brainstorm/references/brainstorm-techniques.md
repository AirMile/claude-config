...
These techniques help creatively expand ideas through exploration, variation generation, and boundary pushing. Use these when you want to discover new possibilities, alternatives, and unexpected directions for your idea.
...
- If we started from zero knowledge, how would we build this?
...
- Rebuilt approach from first principles
- Key differences from original idea
...
- Allow ideas to evolve through additions
...
- Novel features or approaches discovered
- Refined ideas removing absurdity but keeping innovation
...
- Discover fundamental motivations
...
- Refined direction based on insights
...
- Systematically combine different options
...
- Unexpected viable combinations
- Optimal combination(s) suggested

### 13. Provocation Technique
...
- Find the kernel of valuable insight
...
- Translated into practical innovations
- Original ideas sparked
...
- Find opportunities in reversals
...
- Valuable reversals identified
- Alternative approaches based on reversals
...
- How would each person change the idea?
...
- Changes suggested by each role
- Balanced approach incorporating insights
...
- What if societal norms were different?
...
- Future-proof aspects highlighted
- Era-specific innovations discovered
...
- What if [key resource] didn't exist?
...
- What does the metaphor suggest we're missing?
...
- Missing elements revealed
- Practical applications of metaphorical insights
...
- New directions suggested by questions
