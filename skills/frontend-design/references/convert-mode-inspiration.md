...
Theme is **mandatory**. Check `project.json → theme`. If empty: abort with `"This mode requires a theme. Run /frontend-tokens first or choose 1:1 copy."` If populated: read and store tokens — mandatory for mapping.
