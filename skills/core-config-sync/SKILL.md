...
`/core-config-sync` of `/core-config-sync [commit message]`
...
**Auto-generate logic:**
- Als alleen skills: `feat(skills): update [skill-names]`
...
school-website> /core-config-sync
# Detecteert wijziging in SKILL.md
...
**Met custom message:**
```
school-website> /core-config-sync fix typo in commit command
...
- `/core-commit` - Commit in huidige project (niet claude-config)
