...
```
Read: .claude/skills/frontend-wireframe/references/mobile-patterns.md
```

**For desktop wireframes:**

```
Read: .claude/skills/frontend-wireframe/references/desktop-patterns.md
```

**For page-specific patterns:**

```
Read: .claude/skills/frontend-wireframe/references/page-types.md
```

**For game UI (menus, HUD, inventory, etc.):**

```
Read: .claude/skills/frontend-wireframe/references/game-ui-patterns.md
```
...
HTML TEMPLATE:
1. First, READ the file: .claude/skills/frontend-wireframe/references/html-template.html
