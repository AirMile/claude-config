...
Output schema, dedup tokenizer, tag vocabulary, append protocol, and consolidation live in `shared/LEARNING-WRITE.md` — this file covers signal detection and extraction heuristics only.
