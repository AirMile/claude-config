...
- For **conditional next steps** (e.g. dev-verify: refactor vs. define-next): pick the single most relevant branch given the current result and fill in the real name — do not list multiple commands in the modal.
