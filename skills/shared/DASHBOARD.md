...
| [DASHBOARD-THEME.md](DASHBOARD-THEME.md)     | `theme` section of `project.json`: `domain`, tokens, motion packs, springs, choreography, glass, per-domain exports (`cssVars` / `godotTheme`) |
...
| § `theme` (`domain`, tokens, motion, glass, `cssVars`/`godotTheme`) | DASHBOARD-THEME.md § theme                              |
| Domain resolution (web / game / native) for design skills           | DOMAIN.md                                               |
