...
Shared protocol for skills that gather input through user questions — interviews (`dev-define`, `game-define`), exploration rounds (`project-seed`), and technique dialogues (`project-brainstorm`, `project-critique`). Load this file when the question phase starts.
