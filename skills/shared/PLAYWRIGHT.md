...
| `dev-ship` (debug rounds) | Runtime-state inspectie, hypothesis-validatie     | eval (JSON inline)  |
| `game-debug`              | Runtime-state inspectie, hypothesis-validatie     | eval (JSON inline)  |
