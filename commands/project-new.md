---
description: Maak nieuw project met junction-based .claude/ config
---
...
# Junctions (tracked via master repo)
# Note: Git follows junctions, content tracked in claude-config repo
```
